...
public class ListGSYVideoPlayer extends StandardGSYVideoPlayer {
     ...
     */
    protected boolean setUp(List<GSYVideoModel> url, boolean cacheWithPlay, int position,
        ...
        boolean set =
            setUp(gsyVideoModel.getUrl(), cacheWithPlay, cachePath, gsyVideoModel.getTitle(),
                changeState);
