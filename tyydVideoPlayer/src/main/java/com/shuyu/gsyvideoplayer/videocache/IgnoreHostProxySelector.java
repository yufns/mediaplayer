...
class IgnoreHostProxySelector extends ProxySelector {
    ...
    IgnoreHostProxySelector(ProxySelector defaultProxySelector, String hostToIgnore,
        int portToIgnore) {
    ...
    static void install(String hostToIgnore, int portToIgnore) {
        ...
        ProxySelector ignoreHostProxySelector =
            new IgnoreHostProxySelector(defaultProxySelector, hostToIgnore, portToIgnore);
