...
@Deprecated public class ListVideoUtil {
    ...
    private void resolveToFull() {
        systemUiVisibility = ((Activity) context)
            .getWindow()
            .getDecorView()
        ...
        gsyVideoPlayer
            .getFullscreenButton()
            .setImageResource(gsyVideoPlayer.getShrinkImageRes());
        gsyVideoPlayer
            .getBackButton()
    ...
    private void resolveMaterialAnimation() {
        ...
        FrameLayout.LayoutParams lp =
            new FrameLayout.LayoutParams(listItemSize[0], listItemSize[1]);
    ...
    private void resolveToNormal() {
        ...
        handler.postDelayed(new Runnable() {
            @Override public void run() {
                ...
                gsyVideoPlayer
                    .getFullscreenButton()
                    .setImageResource(gsyVideoPlayer.getEnlargeImageRes());
                gsyVideoPlayer
                    .getBackButton()
                    .setVisibility(View.GONE);
                gsyVideoPlayer.setIfCurrentIsFullscreen(false);
