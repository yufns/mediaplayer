 ...
 */
public abstract class GSYBaseADActivityDetail<T extends GSYBaseVideoPlayer, R extends GSYADVideoPlayer>
    extends GSYBaseActivityDetail<T> {

    protected OrientationUtils mADOrientationUtils;

    @Override public void initVideo() {
        super.initVideo();
        //外部辅助的旋转，帮助全屏
     ...
     * 选择builder模式
     */
    @Override public void initVideoBuilderMode() {
            ...
            .setVideoAllCallBack(new GSYSampleCallBack() {
                ...
                @Override public void onAutoComplete(String url, Object... objects) {
                    ...
                    getGSYVideoPlayer()
                        .getCurrentPlayer()
                        .startAfterPrepared();
                    if (getGSYADVideoPlayer()
                        .getCurrentPlayer()
                        .isIfCurrentIsFullscreen()) {
                        getGSYADVideoPlayer().removeFullWindowViewOnly();
                        if (!getGSYVideoPlayer()
                            .getCurrentPlayer()
                            .isIfCurrentIsFullscreen()) {
                            showFull();
                            getGSYVideoPlayer().setSaveBeforeFullSystemUiVisibility(
                                getGSYADVideoPlayer().getSaveBeforeFullSystemUiVisibility());
                        }
                    }
                }
     ...
     * 正常视频内容的全屏显示
     */
    @Override public void showFull() {
        if (orientationUtils.getIsLand() != 1) {
            //直接横屏
            orientationUtils.resolveByClick();
        }
        getGSYVideoPlayer().startWindowFullscreen(this, hideActionBarWhenFull(),
    ...
    @Override protected void onDestroy() {
        ...
        if (mADOrientationUtils != null) mADOrientationUtils.releaseListener();
    }
    ...
    @Override public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (!isPause && getGSYADVideoPlayer().getVisibility() == View.VISIBLE) {
            if (isADStarted()) {
                ...
                getGSYADVideoPlayer()
                    .getCurrentPlayer()
                    .onConfigurationChanged(this, newConfig, mADOrientationUtils,
                        hideActionBarWhenFull(), hideStatusBarWhenFull());
            }
        }
    ...
    @Override public void clickForFullScreen() {
    }

    protected boolean isADStarted() {
        return getGSYADVideoPlayer()
            .getCurrentPlayer()
            .getCurrentState() >= 0
            && getGSYADVideoPlayer()
            .getCurrentPlayer()
            .getCurrentState() != GSYVideoView.CURRENT_STATE_NORMAL
            && getGSYADVideoPlayer()
            .getCurrentPlayer()
    ...
    public void startAdPlay() {
        ...
        if (getGSYVideoPlayer()
            ...
            .isIfCurrentIsFullscreen()) {
            showADFull();
            getGSYADVideoPlayer().setSaveBeforeFullSystemUiVisibility(
                getGSYVideoPlayer().getSaveBeforeFullSystemUiVisibility());
        }
    }
    ...
    public void showADFull() {
        ...
        getGSYADVideoPlayer().startWindowFullscreen(GSYBaseADActivityDetail.this,
            hideActionBarWhenFull(), hideStatusBarWhenFull());
    }
