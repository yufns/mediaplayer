...
public final class GSYExoHttpDataSourceFactory extends BaseFactory {
     ...
     */
    public GSYExoHttpDataSourceFactory(String userAgent, int connectTimeoutMillis,
        int readTimeoutMillis, boolean allowCrossProtocolRedirects) {
        this(userAgent,
            /* listener= */ null, connectTimeoutMillis, readTimeoutMillis,
    ...
    @Override protected GSYExoHttpDataSource createDataSourceInternal(
        HttpDataSource.RequestProperties defaultRequestProperties) {
        GSYExoHttpDataSource dataSource = new GSYExoHttpDataSource(userAgent,
            /* contentTypePredicate= */ null, connectTimeoutMillis, readTimeoutMillis,
