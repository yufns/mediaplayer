 ...
 */
public abstract class GSYBaseActivityDetail<T extends GSYBaseVideoPlayer> extends AppCompatActivity
    ...
    public void showFull() {
        ...
        getGSYVideoPlayer().startWindowFullscreen(GSYBaseActivityDetail.this,
