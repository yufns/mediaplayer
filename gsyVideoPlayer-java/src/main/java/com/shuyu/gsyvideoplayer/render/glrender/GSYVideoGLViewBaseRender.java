 ...
 *
 */
@SuppressLint("ViewConstructor") public abstract class GSYVideoGLViewBaseRender
            ...
            mHandler.post(new Runnable() {
                @Override public void run() {
                    if (mGSYVideoGLRenderErrorListener != null) {
                        mGSYVideoGLRenderErrorListener.onError(GSYVideoGLViewBaseRender.this,
                            op + ": glError " + error, error, mChangeProgramSupportError);
                    }
